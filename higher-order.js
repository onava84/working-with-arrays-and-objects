...
//Code Here
let evenNumbers = mixedNumbers.filter((e, i, a) => {
    if(e % 2 === 0) {
      return e
    }
  }
...
//Code Here
let postTaxPrices = prices.map( (e, i, a) => e = e * 1.07 ) // = prices.map(/* Provide Your Callback Here );
...
//Code Here
let myStrongest = monstersInYourPocket.filter( (e, i, a) => {
    if(a[i].CP > 200) {
      return a[i]
    }
  } 
...
let orderTotals = orders.map( (e, i, a) => e = e.price + (e.price * e.tax)) 
